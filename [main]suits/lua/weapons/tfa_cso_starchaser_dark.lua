...
SWEP.PrintName = "Hell Chaser" -- Weapon name (Shown on HUD)
...
--
--Firing related
SWEP.Primary.Sound = Sound("raygun_fire.wav") -- This is the sound of the weapon, when you shoot.
...
SWEP.DamageType = bit.bor(DMG_SHOCK, DMG_BULLET, DMG_DISSOLVE) --See DMG enum.  This might be DMG_SHOCK, DMG_BURN, DMG_BULLET, etc.
...
--[[VIEWMODEL]]
--
SWEP.ViewModel = "models/weapons/tfa_cso/c_starchaserar_asap.mdl" --Viewmodel path
...
--[[WORLDMODEL]]
--
SWEP.WorldModel = "models/weapons/tfa_cso/w_starchaserar_asap.mdl" -- Worldmodel path
SWEP.Skin = 1
...
SWEP.TracerName = "tfa_tracer_gauss_red" --Change to a string of your tracer name.  Can be custom.
...
function SWEP:Initialize()
	...
	hook.Add("EntityTakeDamage", self, function(_, ent, dmg)
		if ((ent:IsPlayer() or ent:IsNPC()) and dmg:GetInflictor() == self) then
			ent:Ignite(1)
		end
	end)
end