...
if SERVER then
    util.AddNetworkString("ASAP.Arena.Hammer.WonGame")
end
...
GM.Description = "What's this?!(Event)"
GM.CaseReward = 721
GM.Weapons = {
    "tfa_cso2_toyhammer"
}
...
if CLIENT then
    ...
    net.Receive("ASAP.Arena.Hammer.WonGame", function()
        local nick = net.ReadString()
        chat.AddText(Color(245, 160, 80), "[Praetorian Problem!] ", color_white, "Player ", Color(250, 75, 75), nick, color_white, " won the game!")
    end)
end

asapArena:AddGamemode("hammer", GM)