AddCSLuaFile()
ENT.Type = "anim"
ENT.Base = "sent_asap_drop"
ENT.Category = "Galaxium Arena"
ENT.PrintName = "Arena Rare Drop"
ENT.Spawnable = true
...
function ENT:Initialize()
    ...
    timer.Simple(0.5, function()
        ...
        util.Effect("arena_cratesmoke_rare", self.Smoke, true, true)
    end)
end
...
function ENT:Use(ply)
    if (ply:GetActiveWeapon():GetClass() ~= "csgo_bayonet") then
        ply:PrintMessage(HUD_PRINTTALK, "You can only unlock with the golden knife!")
