...
function meta:savePlayTime()
    ...
    ASAPDriver:MySQLUpdate("playtime", {
...
function meta:initPlayTime(data)
    ...
    if data and data.time then
        ...
        ASAPDriver:MySQLInsert("playtime", self.playTime)
    end
...
hook.Add("DatabaseCreateTables", "Nebula.PlayTime", function(fun)
    ASAPDriver:MySQLCreateTable("playtime", {
    ...
    ASAPDriver:MySQLHook("playtime", function(ply, data)
