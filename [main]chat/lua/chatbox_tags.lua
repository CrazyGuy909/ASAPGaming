...
LOUNGE_CHAT.CustomTagsGroups = {
	["owner"] = ":rock: <rainbow=2>Owner</rainbow> | ",		  
	["staffmanager"] = ":mlady: <flash=b62025,2>Management</flash> | ",
	["superadmin"] = ":money: <flash=b62025,2>Management</flash> | ",
	["gamemaster"] = ":scary: <color=9965ff>Gamemaster</color> | ",
	["senioradmin"] = ":gun: <flash=ca5a5a,2>Senior Admin</flash> | ",
	["admin"] = ":thinkies: <color=ff9965>Admin</color> | ",
	["junioradmin"] = ":weeb: <color=ffe665>Junior Admin</color> | ",
	["mod"] = ":thonk: <color=9affee>Moderator</color> | ",
	["trialmoderator"] = ":shutup: <color=aaffaa>Trial Moderator</color> | ",
}
