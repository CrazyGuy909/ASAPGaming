...
function PANEL:Init()
    ...
    self.Search = vgui.Create("XeninUI.TextEntry", self)
    ...
    self.Content = vgui.Create("XeninUI.ScrollPanel", self)
...
function PANEL:LoadData()
    ...
    http.Fetch(asapMarket.API .. "/trade/get?steamid=" .. LocalPlayer():SteamID64(), function(body)
        ...
        for id, trade in SortedPairs(data, true) do
            ...
            btn.name_a:SetFont("XeninUI.TextEntry")
            ...
            btn.name_b:SetFont("XeninUI.TextEntry")
            ...
            btn.DoClick = function(s)
                ...
                http.Fetch(asapMarket.API .. "/trade/get?steamid=" .. trade.player_a .. "&id=" .. id, function(body)
...
vgui.Register("Trade.History", PANEL, "XeninUI.Frame")