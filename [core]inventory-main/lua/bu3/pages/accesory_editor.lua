...
function PAGE:Load(contentFrame, itemData)
	...
	PAGE.ItemData.accessoryID = ""
	PAGE.ItemData.type = "accesory"
	...
	textPanel:SetPos(contentFrame:GetWide()/2 - 200,4)
	textPanel.Paint = function(s , w , h)
		draw.SimpleText("ACCESSORY EDITOR", BU3.UI.Fonts["large_bold"], w/2, h/2, Color(255,255,255,20),1 ,1)
	end
	...
	local weaponClassEntry = BU3.UI.Elements.CreateTextEntry("Accesory ID", self.pages, false, false)
	weaponClassEntry:SetPos(85, 340 + 20 + 40 + (235 - 40 - 5 - 40) + 20 - 40)
	weaponClassEntry:SetSize(300, 40)
	weaponClassEntry:SetText(PAGE.ItemData.accessoryID)
	weaponClassEntry.OnValueChange = function(s , val)
		PAGE.ItemData.accessoryID = val
	end
	...
	local createCaseButton = BU3.UI.Elements.CreateStandardButton("Create/Update Accesory", self.pages, function()
...
--Register the page
BU3.UI.RegisterPage("accesory_editor", PAGE)